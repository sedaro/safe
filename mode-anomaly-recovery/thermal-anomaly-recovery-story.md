...
| Thermal fidelity | The checked-in power-only scenario has no telemetry patches or action-specific inputs and returns only battery state of charge. | Configure state-aligned thermal scenarios and metrics with modeled command effects. |
